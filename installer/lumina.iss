...
; ──────────────────────────────────────────────────────────────────────────────
Root: HKLM; Subkey: "SOFTWARE\Classes\CLSID\{{{#ClsidLuminaShell}}";                    Flags: uninsdeletekey; Permissions: admins-full system-full users-read
Root: HKLM; Subkey: "SOFTWARE\Classes\CLSID\{{{#ClsidLuminaShell}}\InprocServer32";     Permissions: admins-full system-full users-read
